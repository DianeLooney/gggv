...
float _2x2 =
    -256 + (-1 * (_0x0 + _0x1 + _0x2 + _0x3 + _0x4 + _1x0 + _1x1 + _1x2 + _1x3 +
                  _1x4 + _2x0 + _2x1 + _2x3 + _2x4 + _3x0 + _3x1 + _3x2 + _3x3 +
                  _3x4 + _4x0 + _4x1 + _4x2 + _4x3 + _4x4));
...
void main() {
  ...
  aggregator += texture(tex0, vec2((x_step * -2 + fragTexCoord.x),
                                   (y_step * -2 + fragTexCoord.y))) *
                _0x0;
  aggregator += texture(tex0, vec2((x_step * -1 + fragTexCoord.x),
                                   (y_step * -2 + fragTexCoord.y))) *
                _0x1;
  aggregator += texture(tex0, vec2((x_step * 0 + fragTexCoord.x),
                                   (y_step * -2 + fragTexCoord.y))) *
                _0x2;
  aggregator += texture(tex0, vec2((x_step * 1 + fragTexCoord.x),
                                   (y_step * -2 + fragTexCoord.y))) *
